...
<fieldset id="content_header" class="panel">
	...
	<ul>
		...
		<p><a href="{$smarty.const._DPDPOLAND_PRICES_ZIP_URL_|escape:'htmlall':'UTF-8'}" target="_blank">{l s='Check out our prices!' mod='dpdpoland'}</a></p>
		<p>{l s='To send your parcels via DPD, firstly please' mod='dpdpoland'} <a href="mailto: itcustomersupport@dpd.com.pl">itcustomersupport@dpd.com.pl</a> {l s='and then configure your module.' mod='dpdpoland'}</p>
</fieldset>
{if !$ps_16}
	<br />
{/if}